#!/usr/bin/env python3
"""Closed-loop training via mamba ultralytics 8.3 (supports YOLO11 baseline PT)."""
import sys

# When launched from algorithm_model/yolo, drop embedded ultralytics 8.0 from import path.
