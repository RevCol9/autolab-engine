...
import os
# Add project root to Python path for algorithm_model imports
project_root = "/niii_machine_version/AI_trainning_platform/boot-vison-python-master"
...
def generate_ddp_command(world_size, trainer):
    ...
    # Force generate temp file if current script is manage.py (Django) or doesn't meet requirements
    if (not (safe_pattern.match(file) and Path(file).exists() and file.endswith('.py')) or 
        'manage.py' in file):
