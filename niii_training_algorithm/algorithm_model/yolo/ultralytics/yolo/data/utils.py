...
def img2label_paths(img_paths,label_path):
    ...
    sa, sb = f'{os.sep}images{os.sep}', f'{os.sep}{label_path}{os.sep}labels{os.sep}'  # /images/, /labels/ substrings
...
def verify_image_label(args):
    ...
    try:
        ...
        if os.path.isfile(lb_file):
            ...
            nm = 1  # label missing
            #msg = f'{prefix}WARNING ⚠️ {im_file}: ignoring image because of missing label'
